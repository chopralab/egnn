...
#    print(docking_scores)
    ...
    Smiles1, Molecules1, adjacencies1 = '', [], []
    score = []
    ...
    for no, test in enumerate(test_list):
        ...
        fingerprints = create_fingerprints(atoms, i_jbond_dict, radius)
        Molecules1.append(fingerprints)

        adjacency = create_adjacency(mol)
        adjacencies1.append(adjacency)
...
#    print(normalized_separate_energies[2][0])
    ...
    docking_scores1 = normalized_separate_molecules  
    print(docking_scores)        
    ...
    with open(dir_test + 'Smiles.txt', 'w') as f:
        f.write(Smiles1)
    np.save(dir_test + 'Molecules', Molecules1)
    np.save(dir_test + 'adjacencies', adjacencies1)
    np.save(dir_test + 'docking_scores', docking_scores1) 
